  ...
  - step: ^dynamic rows$
    ...
    dataTable:
      ...
      type: dynamic
          ...
          StepDefManifest(
              {StepDef("^columns$", "columns", {},
                       DataTableSpec(TableDirection::Columns, true, "Person")),
               StepDef("^dynamic rows$", "dynamicRows", {},
...
steps:
  ...
  - step: ^no docstring$
    methodName: noDocstring
                ...
                StepDefManifest(
                    {StepDef("^null docstring$", "nullDocstring", {},
                             std::nullopt, DocStringSpec(std::nullopt)),
                     StepDef("^flag docstring$", "flagDocstring", {},
                             std::nullopt, DocStringSpec(std::nullopt)),
                     StepDef("^typed docstring$", "typedDocstring", {},
