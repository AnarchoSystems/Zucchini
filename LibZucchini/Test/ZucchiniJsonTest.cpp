...
std::vector<JsonCase> JsonCases() {
  return {
      JsonCase("PlainStep",
               Zucchini("a scenario", "My Feature",
                        {ZucchiniStep("^I do nothing$", "doNothing",
                                      "I do nothing", {}, {}, 13, 5)},
                        "My Rule"),
      ...
      JsonCase(
          "TypedCaptures",
          Zucchini("captures", "Captures",
                   {ZucchiniStep("^I have (.*) cukes$", "haveCukes",
                                 "I have 42 cukes",
                                 {Capture("count", 42), Capture("tasty", true),
                                  Capture("label", "Bob")},
                                 {}, 14, 3)}),
      ...
      JsonCase("DataTableArgument",
               Zucchini("table", "Tables",
                        {ZucchiniStep("^these people exist$", "peopleExist",
                                      "these people exist", {},
                                      DataTableArgument(
                                          {nlohmann::json{{"name", "Alice"}},
...
INSTANTIATE_TEST_SUITE_P(Zucchinis, ZucchiniJson,
                         testing::ValuesIn(JsonCases()), CaseName);
} // namespace
