...
// One concatenated literal per line keeps the embedded YAML readable and
// indentation-proof.
...
VariableKind
kind_of_type(const StepDefManifest &manifest, const std::string &type,
...
CppType cpp_type(const StepDefManifest &manifest, const Stylesheet &stylesheet,
...
model::FieldDef lower_field(const StepDefManifest &manifest,
...
std::string casing_literal(Casing casing) {
  ...
  case Casing::SnakeCase:
    return "nZucchini::Casing::SnakeCase";
  case Casing::CamelCase:
    return "nZucchini::Casing::CamelCase";
  case Casing::PascalCase:
    return "nZucchini::Casing::PascalCase";
  }
  return "nZucchini::Casing::SnakeCase";
}
} // namespace
