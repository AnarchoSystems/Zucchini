...
if(NOT EXISTS "${ZUCCHINI_EXECUTABLE}" OR NOT EXISTS "${ZUCCHINI_LIBRARY}" OR
    NOT EXISTS "${ZUCCHINI_RUNTIME_LIBRARY}")
...
set_target_properties(ZucchiniLib PROPERTIES
    ...
    INTERFACE_INCLUDE_DIRECTORIES
        "${ZUCCHINI_PROJECT_SOURCE_DIR}/LibZucchini/include"
    INTERFACE_LINK_LIBRARIES
        "")

add_library(ZucchiniRuntime STATIC IMPORTED GLOBAL)
add_library(Zucchini::Runtime ALIAS ZucchiniRuntime)
set_target_properties(ZucchiniRuntime PROPERTIES
    IMPORTED_LOCATION "${ZUCCHINI_RUNTIME_LIBRARY}"
    INTERFACE_COMPILE_FEATURES cxx_std_17
    INTERFACE_INCLUDE_DIRECTORIES
        "${ZUCCHINI_PROJECT_SOURCE_DIR}/ZucchiniRuntime/include;${ZUCCHINI_PROJECT_SOURCE_DIR}/LibZucchini/include;${CUCUMBER_MESSAGES_INCLUDE_DIRS};${JSON_INCLUDE_DIRS};${GTEST_INCLUDE_DIRS}"
    INTERFACE_LINK_LIBRARIES
        "Zucchini::LibZucchini;${CUCUMBER_GHERKIN_LIBRARY};${CUCUMBER_MESSAGES_LIBRARY};${GTEST_LIBRARY}")
