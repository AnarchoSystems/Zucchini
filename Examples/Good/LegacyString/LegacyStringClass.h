...
// Stands in for a legacy string class that predates std::string in some codebases: it owns a
// heap-allocated C string rather than an std::string, and exposes just equality and streaming.
namespace nLegacyString
{
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& stream, const LegacyString& value)
        {
